# SwiftUI Local-First Todo Lab

Companion source for Chapter 7. Add the files under `starter/SwiftTodoLab/` to
a new Xcode SwiftUI iOS app and add the test file to its test target. The app
